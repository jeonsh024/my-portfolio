...
const EXPERIENCES: ExperienceItem[] = [
  {
    ...
    details: [
      '배송사진 AI 검수 자동화 시스템(AI/AX) 기획·설계 주도 — React + Vite 대시보드 개발, Gemini 프롬프트 설계, Claude 활용 풀스택 구축',
      'React Native · Expo 기반 물류 모바일 앱 설계부터 iOS/Android 출시·운영까지 전담 (입고·피킹·배송 등 도메인 구현)',
